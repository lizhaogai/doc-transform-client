...
class Task {
   ...
   *
   * @method
   * @path [GET] /Tasks/downloadOriginal
   * @name Task#downloadOriginal
   * @param {string} externalTaskId - 
   * @param {function} [cb] - Callback function
   */
  downloadOriginal(externalTaskId, cb) {
    // verify the required parameter 'externalTaskId' is set
    if (externalTaskId === undefined || externalTaskId === null) {
      throw new Error("Missing the required parameter 'externalTaskId' when calling downloadOriginal");
    }
    ...
    const path = '/Tasks/downloadOriginal';
   ...
   *
   * @method
   * @path [GET] /Tasks/downloadTransformed
   * @name Task#downloadTransformed
   * @param {string} externalTaskId - 
   * @param {function} [cb] - Callback function
   */
  downloadTransformed(externalTaskId, cb) {
    // verify the required parameter 'externalTaskId' is set
    if (externalTaskId === undefined || externalTaskId === null) {
      throw new Error("Missing the required parameter 'externalTaskId' when calling downloadTransformed");
    }
    ...
    const path = '/Tasks/downloadTransformed';
   ...
   *
   * @method
   * @path [POST] /Tasks/{id}/originalFile
   * @name Task#uploadOriginalFile
   * @param {string} id - Id
   * @param {function} [cb] - Callback function
   */
  uploadOriginalFile(id, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling uploadOriginalFile");
    }
    ...
    const path = utils.buildPath('/Tasks/{id}/originalFile', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /Tasks/{id}/originalFile
   * @name Task#downloadOriginalFile
   * @param {string} id - Id
   * @param {function} [cb] - Callback function
   */
  downloadOriginalFile(id, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling downloadOriginalFile");
    }
   ...
   *
   * @method
   * @path [DELETE] /Tasks/{id}/originalFile
   * @name Task#removeOriginalFile
   * @param {string} id - Id
   * @param {function} [cb] - Callback function
   */
  removeOriginalFile(id, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling removeOriginalFile");
    }
   ...
   *
   * @method
   * @path [POST] /Tasks/{id}/transformedFile
   * @name Task#uploadTransformedFile
   * @param {string} id - Id
   * @param {function} [cb] - Callback function
   */
  uploadTransformedFile(id, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling uploadTransformedFile");
    }
    ...
    const path = utils.buildPath('/Tasks/{id}/transformedFile', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /Tasks/{id}/transformedFile
   * @name Task#downloadTransformedFile
   * @param {string} id - Id
   * @param {function} [cb] - Callback function
   */
  downloadTransformedFile(id, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling downloadTransformedFile");
    }
   ...
   *
   * @method
   * @path [DELETE] /Tasks/{id}/transformedFile
   * @name Task#removeTransformedFile
   * @param {string} id - Id
   * @param {function} [cb] - Callback function
   */
  removeTransformedFile(id, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling removeTransformedFile");
    }
